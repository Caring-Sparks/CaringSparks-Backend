...
exports.sendAdminNotificationEmail = exports.sendInfluencerWelcomeEmail = void 0;
...
const sendInfluencerWelcomeEmail = async (influencer, plainPassword) => {
...
<body>
  <div class="email-container">
    ...
    <div class="content">
      <p class="intro-text">
        🎉 Congratulations ${influencer.name}! Your influencer application has been received.  
      ...
      <div class="info-card">
        ...
        <div class="info-grid">
          ...
          <div class="info-item">
            ...
            <span class="info-value">${influencer.location || "Not specified"}</span>
          </div>
          <div class="info-item">
            <span class="info-label">Phone</span>
            <span class="info-value">${influencer.phone || "Not provided"}</span>
          </div>
          <div class="info-item">
            <span class="info-label">WhatsApp</span>
            <span class="info-value">${influencer.whatsapp || "Not provided"}</span>
          </div>
        </div>
      ...
      <div class="platforms-card">
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">${influencer.instagram.followers || "N/A"} followers • ${influencer.instagram.impressions || "N/A"} impressions</div>
          <div class="platform-url">${influencer.instagram.url || "URL not provided"}</div>
        </div>
        `
                : ""}
...
<span class="platform-name">📘 Facebook</span>
          <div class="platform-stats">${influencer.facebook.followers || "N/A"} followers • ${influencer.facebook.impressions || "N/A"} impressions</div>
          <div class="platform-url">${influencer.facebook.url || "URL not provided"}</div>
        </div>
        `
                : ""}
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">${influencer.twitter.followers || "N/A"} followers • ${influencer.twitter.impressions || "N/A"} impressions</div>
          <div class="platform-url">${influencer.twitter.url || "URL not provided"}</div>
        </div>
        `
                : ""}
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">${influencer.tiktok.followers || "N/A"} followers • ${influencer.tiktok.impressions || "N/A"} impressions</div>
          <div class="platform-url">${influencer.tiktok.url || "URL not provided"}</div>
        </div>
        `
                : ""}
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">${influencer.youtube.followers || "N/A"} followers • ${influencer.youtube.impressions || "N/A"} impressions</div>
          <div class="platform-url">${influencer.youtube.url || "URL not provided"}</div>
        </div>
        `
                : ""}
      </div>
    ...
    <div class="footer">
      <p class="footer-text">
        This email was sent to ${influencer.email} because you applied to our influencer program.
      </p>
...
exports.sendInfluencerWelcomeEmail = sendInfluencerWelcomeEmail;
const sendAdminNotificationEmail = async (influencer) => {
    const companyName = "CaringSparks";
    const mailOptions = {
    ...
    <div class="content">
      ...
      <div class="info-card">
        ...
        <div class="info-item" style="margin-top: 12px;">
          ...
          <span class="info-value">${influencer.niches && influencer.niches.length > 0
            ? influencer.niches.join(" • ")
            : "Not specified"}</span>
        </div>
      </div>
      
      ${["instagram", "twitter", "tiktok", "youtube", "facebook"].some((platform) => influencer[platform])
            ? `
      <!-- Social Media Platforms -->
      <div class="platforms-card">
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">
            <div class="stat-item">
              <div class="stat-number">${influencer.instagram.followers || "N/A"}</div>
              <div class="stat-label">Followers</div>
            </div>
            <div class="stat-item">
              <div class="stat-number">${influencer.instagram.impressions || "N/A"}</div>
...
<span class="platform-name">📘 Facebook</span>
          ...
          <div class="platform-stats">
            <div class="stat-item">
              <div class="stat-number">${influencer.facebook.followers || "N/A"}</div>
              <div class="stat-label">Followers</div>
            </div>
            <div class="stat-item">
              <div class="stat-number">${influencer.facebook.impressions || "N/A"}</div>
              <div class="stat-label">Impressions</div>
            </div>
          </div>
          <div class="platform-url">${influencer.facebook.url || "URL not provided"}</div>
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">
            <div class="stat-item">
              <div class="stat-number">${influencer.twitter.followers || "N/A"}</div>
              <div class="stat-label">Followers</div>
            </div>
            <div class="stat-item">
              <div class="stat-number">${influencer.twitter.impressions || "N/A"}</div>
              <div class="stat-label">Impressions</div>
            </div>
          </div>
          <div class="platform-url">${influencer.twitter.url || "URL not provided"}</div>
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">
            <div class="stat-item">
              <div class="stat-number">${influencer.tiktok.followers || "N/A"}</div>
              <div class="stat-label">Followers</div>
            </div>
            <div class="stat-item">
              <div class="stat-number">${influencer.tiktok.impressions || "N/A"}</div>
              <div class="stat-label">Impressions</div>
            </div>
          </div>
          <div class="platform-url">${influencer.tiktok.url || "URL not provided"}</div>
        ...
        <div class="platform-item">
          ...
          <div class="platform-stats">
            <div class="stat-item">
              <div class="stat-number">${influencer.youtube.followers || "N/A"}</div>
              <div class="stat-label">Subscribers</div>
            </div>
            <div class="stat-item">
              <div class="stat-number">${influencer.youtube.impressions || "N/A"}</div>
              <div class="stat-label">Impressions</div>
            </div>
          </div>
          <div class="platform-url">${influencer.youtube.url || "URL not provided"}</div>
